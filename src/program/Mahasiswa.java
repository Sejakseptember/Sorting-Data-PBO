...
public class Mahasiswa {
    ...
    public void sortIpk() {
        Collections.sort(sMahasiswa, (Mahasiswa t, Mahasiswa t1) -> t.getIpk().compareTo(t1.getIpk()));
        
        sMahasiswa.stream().forEach((mahasiswa) -> {
    ...
    public void sortNama() {
        Collections.sort(sMahasiswa, (Mahasiswa t, Mahasiswa t1) -> t1.getNama().compareTo(t.getNama()));
    ...
    public void sortNim() {
        Collections.sort(sMahasiswa, (Mahasiswa t, Mahasiswa t1) -> t.getNim().compareTo(t1.getNim()));
